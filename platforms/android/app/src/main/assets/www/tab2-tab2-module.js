...
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-title>\n      Scheduled Messages\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n  <ion-list>\n    <ion-item *ngFor=\"let item of this.api.scheduledmessage\">\n      <h3>{{item.message}}</h3>\n      <!-- <ion-list slot='end'>\n        <ion-item *ngIf='item.text === true'>Text</ion-item>\n        <ion-item *ngIf='item.email === true'>Email</ion-item>\n        <ion-item *ngIf='item.push === true'>Push</ion-item>\n        <ion-item>{{item.time}}</ion-item>\n        <ion-item>{{item.date}}</ion-item>\n        <ion-item>{{item.frequency}}</ion-item>\n      </ion-list> -->\n      <ion-button (click)='showdetails(item)' slot='end'>Details</ion-button>\n      <ion-icon (click)='confirmdelete(item)' slot='end' name=\"trash\"></ion-icon>\n    </ion-item>\n  </ion-list>\n\n\n\n</ion-content>"
...
var Tab2Page = /** @class */ (function () {
    function Tab2Page(api, alert) {
        this.api = api;
        this.alert = alert;
        console.log(this.api.scheduledmessage);
    }
    Tab2Page.prototype.showdetails = function (item) {
        this.details(item);
    };
    Tab2Page.prototype.details = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            var withtext, withemail, withpush, alert;
    ...
    Tab2Page.prototype.delete = function (item) {
        var index = this.api.scheduledmessage.indexOf(item);
        this.api.scheduledmessage.splice(index, 1);
    };
    Tab2Page.prototype.confirmdelete = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return __generator(this, function (_a) {
    ...
    Tab2Page = __decorate([
        ...
        __metadata("design:paramtypes", [_restapi_service__WEBPACK_IMPORTED_MODULE_1__["RestapiService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["AlertController"]])
    ], Tab2Page);
    return Tab2Page;
}());
